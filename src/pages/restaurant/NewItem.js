...
const RestaurantNewItem = () => {
    ...
    return (
        <>
            <div className="bg-white bg-opacity-80 rounded-lg shadow-lg p-8 mx-auto max-w-xl mt-32 text-center flex flex-col justify-evenly">
                ...
                <div className="mt-8 space-y-4 w-full">
                    <div className="w-full flex justify-center">
                        <form className="w-2/3 flex flex-col justify-evenly items-center text-left" onSubmit={handleSubmit}>
                            <Input
                                type="text"
                                placeholder="Name"
                                value={name}
