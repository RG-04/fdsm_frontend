                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="flex items-center border-b-1 border-t-0 border-r-0 border-l-0 border-solid border-gray-300 pb-6 pt-6">
                            ...
                            <p className="text-lg text-gray-800t">{restaurantInfo.tags ? (restaurantInfo.tags.join(", ")) : ("")}</p>
                        </div>

                        <div className="flex items-center border-b-1 border-t-0 border-r-0 border-l-0 border-solid border-gray-300 pb-6 pt-6">
                            <i className="fas fa-clock text-xl mr-4 text-gray-700"></i>
                            <p className="text-lg text-gray-800">{String(restaurantInfo.timings.open).padStart(2, '0')} hrs to {String(restaurantInfo.timings.close).padStart(2, '0')} hrs </p>
                        </div>
