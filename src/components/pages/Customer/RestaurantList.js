...
const CustomerRestaurantList = () => {
  ...
  const handleSortByRating = (rating) => {
    ...
    setRestaurantsInfo(
      allRestaurantsInfo.filter((restaurant) => restaurant.rating >= rating)
    );
  };
  ...
  const handleSearchBar = (searchVal) => {
    ...
    setRestaurantsInfo(
      allRestaurantsInfo.filter((restaurant) =>
          ...
          <div className="main-container">
            ...
            <div className="sort-container">
              ...
              <select
                className="sorter"
                value={sortCuisine}
                onChange={(e) => handleSortByCuisine(e.target.value)}
              >
