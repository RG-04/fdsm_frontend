...
import "./DeliveryAgentOrders.css";
...
const ManagementDeliveryAgentOrders = () => {
    ...
    useEffect(() => {
        ...
        const url = process.env.REACT_APP_BACKEND_URL + "/api/management/orders/deliverer/" + deliveryAgentID;
        ...
        fetch(url, {
            ...
            const url2 = process.env.REACT_APP_BACKEND_URL + "/api/management/deliverer/" + deliveryAgentID;
            fetch(url2, {
              method: "GET",
              headers: {
                "Content-Type": "application/json",
    ...
    return (
        <>
            <div className="management-delivery-agent-orders">
                <div className="all-container">
                    <ManagementNavbar />

                    <div className="main-container">
                        <div className="title">Orders for: {deliveryAgentInfo.name}</div>
                    </div>
...
export default ManagementDeliveryAgentOrders;